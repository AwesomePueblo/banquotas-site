...
- [ ] Create new standalone GitHub repo for Tony's site
- [ ] Build standalone site (replace calendar with quote request form)
- [ ] Set up business email tony@tonyslandclearing.com
- [ ] Set up Tony's Google account
- [ ] Set up Google Business Profile
- [ ] Add partners section (Brentwood Dirt Works / Trevor)
